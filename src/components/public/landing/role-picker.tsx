    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
      {ROLES.map((r) => {
        ...
        const cls = `flex flex-col rounded-[14px] border p-6 min-h-[224px] ${
          active
            ? "hos-glass hos-sweep-card transition-[transform,box-shadow] duration-300 hover:scale-[1.03] hover:border-border-strong hover:shadow-[0_24px_60px_-24px_rgb(var(--drop-orange)/0.55)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
