...
const FEATURES: Feature[] = [
  {
    Icon: Users,
    t: "No pierdas oportunidades",
    d: "Un CRM con puntaje automático te dice a quién contactar primero y en qué etapa va cada trato. Ningún venue ni booker se te enfría por olvido.",
    p: ["Pipeline", "Score auto", "Follow-ups"],
  },
  {
    Icon: Calendar,
    t: "Sabes cuánto ganas al mes",
    d: "Tu calendario suma lo cobrado y lo pendiente: sabes cuánto ganaste y cuánto te deben, de un vistazo. Vista lista, mes y mapa de gigs.",
    p: ["Cobrado", "Pendiente", "Mes / Mapa"],
  },
  {
    Icon: ImageIcon,
    t: "Preséntate profesional en segundos",
    d: "Bio, música, galería, rider y disponibilidad en una página pública que compartes con un solo link. Se acabó armar el press kit a mano cada vez.",
    p: ["Galería", "Tech rider", "Link público"],
  },
  {
    Icon: TrendingUp,
    t: "Sabes si tu carrera crece",
    d: "Seguidores, posts y campañas en un panel. Mides qué mueve la aguja de verdad, no métricas de vanidad.",
    p: ["IG", "YouTube", "SoundCloud"],
  },
  {
    Icon: Search,
    t: "Que te encuentren los bookers",
    d: "Apareces en el directorio. Activas “disponible para tocar” y subes en las búsquedas con Smart Match, así te contactan sin que persigas a nadie.",
    p: ["Directorio", "Disponible", "LIVE"],
  },
  {
    Icon: Music,
    t: "Que te escuchen sin fricción",
    d: "Tus sets de SoundCloud, YouTube y Spotify suenan dentro del press kit. El booker te escucha ahí mismo, sin abrir diez pestañas.",
