        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className={`p-3 border-2 border-ink text-left transition-colors ${
              !isPaid ? "bg-orange text-ink" : "bg-white hover:bg-cream"
            }`}
          >
                ...
                return (
                  <button
                    ...
                    className={`p-2 border-2 border-ink text-left transition-colors flex items-center gap-2 ${
                      active ? "bg-orange text-ink" : "bg-white hover:bg-cream"
                    }`}
                  >
            ...
            return (
              <div
                ...
                className={`p-3 border-2 transition-colors ${
                  active ? "border-ink bg-cream" : "border-fg-subtle bg-white"
                }`}
              >
