...
- [ ] ⚪ Paginación CRM a escala · acciones masivas · ~~duplicar plantilla~~ ✅ (hecho 2026-07-01: botón "Duplicar" en `/plantillas` → clona con "(copia)" y lleva a editarla; verificado end-to-end) · ~~botón PNG tracklist (BUG-02)~~ (resuelto: el botón se escondió) · drill-down posts→campaña en Growth. *(Ya hechos en sesiones recientes: validación email/WhatsApp server-side en contactos —2026-06-11—; dedup/idempotencia en crons —growth sync + MP webhook—.)*
